...
The tutorials up to this point focussed heavily on goal based actions. The following SMACH tutorial will show you how to use Move Base Flex to perform the planning yourself, giving you way more flexibility.
